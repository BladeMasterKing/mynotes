#### 安装libfastcommon ####
在[github](https://github.com/happyfish100/libfastcommon/archive/V1.0.39.tar.gz)上下载libfastcommon包
```
# 解压tar.gz包
...
```
#### 安装FastDFS ####
在[Github](https://github.com/happyfish100/fastdfs/archive/V5.11.tar.gz)上下载FastDFS的源码
```
# 解压FastDFS的tar.gz包
...
在[Github](https://github.com/happyfish100/fastdfs-nginx-module/archive/V1.20.tar.gz)上下载fastdfs-nginx-module的源码:
```
# 编译nginx并安装
...
> 注意：nginx编译安装完成之后，nginx的存放路径在 /usr/local/nginx 目录下，nginx的启动脚本配置文件都在这个目录下，不再使用源码包conf目录下的文件
